...
# --- CẤU HÌNH ĐƯỜNG DẪN ---
FOLDER_REF = "ket_qua/ref"
FOLDER_GEN = "ket_qua/gen"
...
def plot_mel(real_path, gen_path, out_path):
    ...
    # Tạo một trục riêng cho colorbar
    cbar_ax = fig.add_axes([0.92, 0.15, 0.015, 0.7])  # [left, bottom, width, height]
    fig.colorbar(img1, cax=cbar_ax, format='%+2.0f dB', label='Decibels')

    plt.subplots_adjust(right=0.9)  # tránh trùng lặp với colorbar
    plt.tight_layout(rect=[0, 0, 0.9, 1])  # chừa khoảng cho colorbar
