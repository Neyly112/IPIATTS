...
# ==========================================
CHECKPOINT_PATH = "logs\\matcha_vi\\checkpoints\\checkpoint_epoch599_culocmoi.ckpt"
TEST_FILE_PATH = "data\\99-audio-text-file-list\\audio_text_test_filelist_culocmoi.txt"

# [QUAN TRỌNG] Đường dẫn thư mục chứa file WAV GỐC để copy sang
SOURCE_WAV_FOLDER = "data\\subs_add_con"

OUTPUT_FOLDER = "ket_qua_test"  # Folder tổng
NUM_SAMPLES = 500                      # Số lượng mẫu
